...
<template>
  <footer class="bg-gray-100 dark:bg-slate-950">
    <div class="relative mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 lg:pt-24">
      <div class="absolute end-4 top-4 sm:end-6 sm:top-6 lg:end-8 lg:top-8">
        <button
          class="inline-block rounded-full bg-amber-600 p-2 text-white shadow transition hover:bg-amber-500 dark:bg-gray-700 dark:text-amber-300 dark:hover:bg-gray-600 sm:p-3 lg:p-4"
          @click="scrollToTop"
        >
      ...
      <div class="lg:flex lg:items-end lg:justify-between">
        <div>
          <div class="flex justify-center text-amber-600 dark:text-amber-300 lg:justify-start">
            <ApplicationLogo />
          </div>
